...
public class ScpFrom {
	private static final org.slf4j.Logger logger =  LoggerFactory.getLogger(ScpFrom.class.getName());
    private String host;
    private String user;
    ...
    public ScpFrom(String host, String user, String password, String pubKeyFile, String setKnownHosts) {
        this.host = host;
        this.user = user;
...
/*
    public void localReceivefile(String LFile, String RFile) throws Exception {
        ...
        ExecSSH ex = new ExecSSH(RFile, RFile, RFile, pubKeyFile, setKnownHosts);
