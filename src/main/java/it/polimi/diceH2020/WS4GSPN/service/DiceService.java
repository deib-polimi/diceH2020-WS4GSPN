package it.polimi.diceH2020.WS4GSPN.service;
...
import it.polimi.diceH2020.WS4GSPN.repository.SimulationsManagerRepository;
import it.polimi.diceH2020.WS4GSPN.repository.SimulationsRepository;
import it.polimi.diceH2020.WS4GSPN.utility.ExcelWriter;
import it.polimi.diceH2020.WS4GSPN.utility.ExcelWriter2;
import it.polimi.diceH2020.WS4GSPN.utility.SshConnector;
...
public class DiceService {
	...
	public TaskExecutor taskExecutor(){
		SshConnector sshConnection = new SshConnector(host, user, psw, pk, setKnownHosts);
		List<String> list;
		int maxPoolSize = 2;
	...
	public void simulationV7(SimulationsManager sim_manager){
