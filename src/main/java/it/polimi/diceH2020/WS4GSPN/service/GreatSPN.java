...
public class GreatSPN {
   ...
   public GreatSPN(String host, String user, String pk, String setKnownHosts, String psw) {
		...
		GreatSPN.execute = new SshConnector(host,user,psw,pk,setKnownHosts);
	}
	private String host;
	private String user;
	private String pk;
	...
	//static SshConnector execute=new SshConnector("greatspn.dei.polimi.it","user","b9c744be"); <--- with PSW
	static SshConnector execute;
	...
	public SshConnector getConnection(){
		return execute;
	}
